      ...
      <aside className={`fixed md:static top-[32px] bottom-[72px] md:top-auto md:bottom-auto start-0 z-50 w-64 md:w-56 lg:w-64 shrink-0 border-e border-slate-200/70 dark:border-white/[0.06] bg-[#f5f5f7] dark:bg-[#2c2c2e] md:bg-[#f5f5f7]/80 md:dark:bg-[#2c2c2e]/80 backdrop-blur-xl flex flex-col overflow-y-auto no-scrollbar transform transition-transform duration-200 ease-out ${drawerOpen ? 'translate-x-0' : '-translate-x-full rtl:translate-x-full md:translate-x-0'}`}>
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b border-slate-200/70 dark:border-white/[0.06]">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] text-slate-400 dark:text-white/40">AxonClawX</p>
          </div>
        </div>
              ...
              <div className={rowCls}>
                <div className="px-4 py-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <SmartLink href="https://github.com/AxonClawX/AxonClawX"
                    ...
                    <SmartLink href="https://github.com/AxonClawX/AxonClawX/issues"
                      className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors">
          ...
          {activeTab === 'about' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col items-center pt-4 pb-2">
                ...
                <h3 className="text-[20px] font-bold text-slate-800 dark:text-white tracking-wide">AxonClawX</h3>
                ...
                <div className="px-5 py-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <SmartLink href="https://github.com/AxonClawX/AxonClawX"
                      ...
                      <span className="text-[20px]">🦀</span>
                      <div className="flex-1 min-w-0">
                        <p className="text-[13px] font-bold text-slate-700 dark:text-white/70 group-hover:text-primary">AxonClawX</p>
                        <p className="text-[10px] text-slate-400 dark:text-white/20 truncate">github.com/AxonClawX/AxonClawX</p>
                      </div>
                      <span className="material-symbols-outlined text-[14px] text-slate-300 dark:text-white/15 group-hover:text-primary">open_in_new</span>
                    </SmartLink>
              ...
              <p className="text-center text-[10px] text-slate-300 dark:text-white/10 pb-2">
                &copy; {new Date().getFullYear()} AxonClawX &middot; Made with &#x2764;&#xFE0F;
              </p>
            </div>
          )}
